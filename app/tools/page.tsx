        ...
        <div className="container mx-auto py-12 px-4">
            ...
            <section id="tools" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
                {Object.values(EXAMS).map((exam) => {
                    ...
                    return (
                        <Card key={exam.id} className="hover:shadow-xl transition-all hover:-translate-y-1 border-t-4 border-t-primary/20 bg-white dark:bg-slate-950 dark:border-slate-800">
                            <CardHeader>
